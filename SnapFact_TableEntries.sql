...
('Celery has negative calories! It takes more calories to eat a piece of celery than the celery has in it to begin with. Its the same with apples!'),
...
('Over the last 150 years the average height of people in industrialised nations has increased 10 cm (about 4 inches). In the 19th century, American men were the tallest in the world, averaging 1,71m (56). Today, the average height for American men is 1,75m (57), compared to 1,77 (58) for Swedes, and 1,78 (58.5) for the Dutch. The tallest nation in the world is the Watusis of Burundi.'),
...
('Joseph Niepce developed the worlds first photographic image in 1827. Thomas Edison and W K L Dickson introduced the film camera in 1894. But the first projection of an image on a screen was made by a German priest. In 1646, Athanasius Kircher used a candle or oil lamp to project hand-painted images onto a white screen.'),
...
('The first full moon to occur on the winter solstice, Dec. 22, commonly called the first day of winter, happened in 1999. Since a full moon on the winter solstice occurred in conjunction with a lunar perigee (point in the moons orbit that is closest to Earth), the moon appeared about 14% larger than it does at apogee (the point in its elliptical orbit that is farthest from the Earth).')